...
\newcommand{\thuundergrad}{
    ...
    \item Exchanged at University of Minnesota in 2019 Fall
    }
}
...
\newcommand{\ryanresearch}{
    ...
    \item Assisted the maintenance of data ETL pipeline of several other projects using Python, MongoDB, and Amazon S3, including one for TikTok video and hashtags, and one for tabular data from Nordstrom
    }
}
