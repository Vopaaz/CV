\newcommand{\pennmaster}{
    ...
    {Sep 2021 - Jun 2023}
    {Philadelphia, PA}{
    \item Selected courses: Software Systems, Computational Linguistics, Big Data Analytics
    }
}
...
\newcommand{\msra}{
    ...
    \item Engaged in the design, optimization, and implementation of this large-scale cloud service failure diagnosis algorithm. Conducted literature review of about 15 related works and reproduced two of them, conducting comparative experiments.
    \item Cooperated with Office 365 and other internal application teams to develop Flask API services or Kusto plugins which incorporated the algorithm into the alerting pipeline. The engineers' anomaly mitigation time were significantly reduced.
    }
}
