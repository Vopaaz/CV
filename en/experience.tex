\newcommand{\thuundergrad}{
    ...
    {Sep 2017 - Jun 2021}
    {Beijing, China}{
    \item GPA: 3.83/4.0 (Ranking: 3/29)
...
\newcommand{\continental}{
    ...
    {Shanghai, China}{
        \item Extract data from Oracle Database and applied MicroStrategy Business Intelligence tools and KNIME open source platform to complete data mining tasks. Analyzed and predicted important production indicators such as First Pass Yield, and made interactive visualization charts for the decision makers
        \item Engaged in the firm's implementation process of RPA (Robotic Process Automation). Evaluated the vendors and prepared for the proof-of-concept meeting. Independently developed the first automatic process in the firm for the logistics department using UiPath RPA software, and shared the experiences and knowledge with colleges to promote its institutionalization
    }
}
