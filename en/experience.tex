...
\newcommand{\msra}{
    ...
    \item Conducted literature review of about 15 related literatures and reproduced two of them, conducting comparative experiments
    \item Cooperated with Office and other internal application teams to develop Flask API services based on the algorithm, helping them to diagnose service alerts, which also helped to provide cases for algorithm improvement
    }
}
...
\newcommand{\tkd}{
    ...
    \item Ranked $\text{5}^{\text{th}}$, individually, in the Beijing University Taekwondo Competition, and led the team to win $\text{2}^{\text{nd}}$ Place Prize
    }
}
