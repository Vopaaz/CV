...
\newcommand{\msra}{
    ...
    {Aug 2020 - Mar 2021}
    {Beijing, China}{
    \item Listed as the third author of the paper accepted by SIGKDD 2021, \textit{HALO: Hierarchy-aware Fault Localization for Cloud Systems}. Awarded the ``Stars of Tomorrow'' award of excellence
    \item Engaged in the design, optimization, and implementation of this large-scale cloud service failure diagnosis algorithm. Conducted literature review of about 15 related works and reproduced two of them, carrying out comparative experiments
    \item Cooperated with Office 365 and other internal application teams to develop Flask API services or Kusto plugins which incorporated the algorithm into the alerting pipeline. The engineers' anomaly mitigation time was significantly reduced
    }
}
...
\newcommand{\ryanresearch}{
    \Experience
    {Research Assistant}
    {Supervisor: Prof. Ryan Dew of University of Pennsylvania, Wharton School}
    {Sep 2021 - Present}
    {Philadelphia, PA}{
    \item Engaged in the research project about adaptive user preference measurement, developing a website for data collection with React and Flask. Implemented various features such as attention check questions and multiple products comparison
