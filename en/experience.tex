...
\newcommand{\eyds}{
    ...
    {May 2019}
    {Shanghai, China}{
        \item Completed the task of predicting the residents' moving path destinations in the preliminary contest which has more than 2700 global participants. Contributed 80\% of the ideas of feature engineering, independently build the workflow framework with Python. Finished model selection and hyper-parameter optimization with my teammate. Eventually, \href{https://github.com/Vopaaz/EY-DS-Competition.git}{our solution} won the fourth place in China
        \item Made \href{https://github.com/Vopaaz/EY-DS-Competition-Slides.git}{presentation slides} using Reveal.js independently in the Chinese regional final, and stated our thoughts during the exploration clearly, analyzed the prediction result and proposed several business implications with my teammate. Because of our outstanding presentation, we won the championship in the regional final
    }
}